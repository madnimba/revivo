...
router.get('/',async(req,res)=>{
    ...
    let product=[];
     product=await DB_shop.getOrderProductsBySeller(id,orderId);
    ...
    res.render('SellerOrders.ejs',{order_details:order_details,flag:flag,warning:""});
    }
    if(order_details.length==0){
      res.render('SellerOrders.ejs',{order_details:order_details,warning:"No orders to show"});
    }
})
